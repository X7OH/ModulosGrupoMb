 ...
 * COLUMBA FECHA DE CREACION: 7 DE MARZO DEL 2016
 */
...
public class DocSettlement extends AcctServer {
  ...
  public DocSettlement(String AD_Client_ID, String AD_Org_ID,
  ...
  private DocLine[] loadLines(ConnectionProvider conn) {
    ...
    try {
      ...
      for (int i = 0; data != null && i < data.length; i++) {
        ...
        DocLine_Settlement docLine = new DocLine_Settlement(DocumentType, Record_ID, t_Line_ID);
      ...
      try {
        if (line.m_IsComplete.equals("N")) {
          ...
          if (data.length > 0) {
            ...
            datatypeconcept = ConceptInfoSettlementData.selectConceptType(conn,
                line.m_SSPR_Concept_ID);
            ...
            if (datatypeconcept[0].conceptsubtype.equals("In")) {
              ...
              if (account != null) {
                ...
                strMessage = Utility.messageBD(conn,
                    "No found account for the concept " + line.m_NameConcept, language);
