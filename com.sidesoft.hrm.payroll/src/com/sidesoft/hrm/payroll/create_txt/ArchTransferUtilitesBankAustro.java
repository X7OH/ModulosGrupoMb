...
public class ArchTransferUtilitesBankAustro extends DalBaseProcess {
  ...
  public void doExecute(ProcessBundle bundle) throws Exception {
    ...
    try {
      ...
      ArchTransferUtilitesBankAustroData data[] = ArchTransferUtilitesBankAustroData.select(conn,
          strYear,strBanktransfer);
      if (data != null && data.length > 0) {
        ...
        response.setHeader("Content-Disposition",
            "attachment; filename=TransferenciaUtilidadesBancodelAustro.txt");
        // Build txt file
        ...
        try {
          ...
          out.write("\t");
          out.write("\r\n");   // write new line
          for (ArchTransferUtilitesBankAustroData archPAPProduBankData : data) {
