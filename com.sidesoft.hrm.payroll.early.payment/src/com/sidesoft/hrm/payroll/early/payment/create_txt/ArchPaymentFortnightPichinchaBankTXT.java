...
public class ArchPaymentFortnightPichinchaBankTXT extends DalBaseProcess {
  ...
  public void doExecute(ProcessBundle bundle) throws Exception {
    ...
    try {
      ...
      ArchPaymentFortnightPichinchaBankData data[] = ArchPaymentFortnightPichinchaBankData.select(conn,
      ...
      if (data != null && data.length > 0) {
        ...
        response.setHeader("Content-Disposition", "attachment; filename=PayFortnightPichinchaBank.txt");
        // Build txt file
        ...
        try {
          ...
          for (ArchPaymentFortnightPichinchaBankData archPTransfData : data) {
