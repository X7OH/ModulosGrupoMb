...
public class ArchPayrAdvPayRuminahuiBankTXT extends DalBaseProcess {
  ...
  public void doExecute(ProcessBundle bundle) throws Exception {
    ...
    try {
      ...
      final String strTypeofIncome = (String) bundle.getParams().get("typeofincome");
      ...
      ArchPayrAdvPayRuminahuiBankData data[] = ArchPayrAdvPayRuminahuiBankData.select(conn, strDocumentNo, strTypeofIncome);
      if (data != null && data.length > 0) {
        ...
        response.setHeader("Content-Disposition", "attachment; filename=PayrAdvPayRuminahuiBank.txt");
        // Build txt file
        ...
        try {
          ...
          out.write("codigo servicio");
          out.write("\t");
          out.write("Numero ID Cliente");
          out.write("\t");
          out.write("moneda");
          out.write("\t");
          out.write("valor incluido 2 decimales sin el punto");
          out.write("\t");
          out.write("CTA");
          out.write("\t");
          out.write("tipo cta");
          ...
          out.write("cuenta");
          out.write("\t");
          out.write("Referencia, maximo 40 caracteres");
          out.write("\t");
          out.write("Tipo ID Cliente");
          out.write("\t");
          out.write("Numero ID Cliente");
          out.write("\t");
          out.write("Nombre cliente");
          out.write("\t");
          out.println("Codigo de Banco, ver Tabla-IFIS BGR = 42");
          Integer secuencial = 1;
          for (ArchPayrAdvPayRuminahuiBankData archPAPRumBankData : data) {
            ...
            out.write("\t");
            out.write(archPAPRumBankData.amount.toString().replaceAll("\\.","").replaceAll(",",""));
            out.write("\t");
