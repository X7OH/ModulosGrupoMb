...
@WebServlet("/ec.com.sidesoft.integration.pedidosya.webservices.webhooks.WebHookBuffalos")
public class WebHookBuffalos extends HttpServlet{
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
        	...
        	try {
                rev = processdata.getNotifyResponse(newJson, "BF");
