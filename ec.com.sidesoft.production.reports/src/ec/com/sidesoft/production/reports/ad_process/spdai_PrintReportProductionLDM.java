package ec.com.sidesoft.production.reports.ad_process;
...
public class spdai_PrintReportProductionLDM extends HttpSecureAppServlet {
  private static Logger log4j = Logger.getLogger(spdai_PrintReportProductionLDM.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      String strDocumentId = vars.getSessionValue("191|M_PRODUCTION_ID");
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    StrWindowdID = "191";
    StrTableID = "325";
    String StrTransactionID = vars.getSessionValue("191|M_PRODUCTION_ID");

    ProductionTransaction SsprSettlement = OBDal.getInstance().get(ProductionTransaction.class,
        StrTransactionID);
    ...
    DocumentType doctype = OBDal.getInstance().get(DocumentType.class,
        SsprSettlement.getSpdaiDocumentType().getId().toString());
    ...
    if (LstTemplate.get(0).getWindow().getId().equals(StrWindowdID)) {
      ...
      parameters.put("AD_USER", strUser);
      ...
      // "attachment;
      // StrNameReport = StrNameReport.replace(".jrxml", ".pdf");
