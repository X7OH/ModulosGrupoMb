...
public class EM_Slqs_CreateFrom extends HttpSecureAppServlet {
  ...
  protected void printPageInvoice(HttpServletResponse response, VariablesSecureApp vars,
    ...
    CreateFromLocatorData[] dataLoc = null; // Cargar Ubicación/Hueco
    ...
    if (strPO.equals("") && strShipment.equals("")) {
      ...
      xmlDocument = xmlEngine.readXmlTemplate(
          "ec.com.sidesoft.localization.quality.assurement.ad_forms/CreateFrom_Invoice", discard)
          .createXmlDocument();
      data = CreateFromInvoiceData.set();
    } else {
      xmlDocument = xmlEngine
          .readXmlTemplate(
              "ec.com.sidesoft.localization.quality.assurement.ad_forms/CreateFrom_Invoice")
          .createXmlDocument();

      data = CreateFromInvoiceData.selectFromLoc(this, vars.getLanguage(), "Y");
      ...
      for (int k = 0; k < ids.length; k++) {
        ...
        if (data != null) {
          ...
          for (int i = 0; i < data.length; i++) {
            ...
            if (!strPO.equals("")) {
              String strInvoiceprepaymentamt = CreateFromInvoiceData
                  .selectInvoicePrepaymentAmt(this, strKey);
              BigDecimal invoiceprepaymentamt = (strInvoiceprepaymentamt.equals("")
                  ? BigDecimal.ZERO
