...
public class Ssrs_PrintReportFinalResupply extends HttpSecureAppServlet {
  private static Logger log4j = Logger.getLogger(Ssrs_PrintReportFinalResupply.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      String strDocumentId = vars
          .getSessionValue("23A1386D3BDF4B1E938F26775441EF94|SSRS_RESUPPLY_ID");
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    String StrTableID = "";
    String strADUSerID = "";
    StrWindowdID = "23A1386D3BDF4B1E938F26775441EF94";
    StrTableID = "2E056D09471E4483BEEBB771BACA7743";
    String StrTransactionID = vars
        .getSessionValue("23A1386D3BDF4B1E938F26775441EF94|SSRS_RESUPPLY_ID");

    ssrsresupply SsprSettlement = OBDal.getInstance().get(ssrsresupply.class, StrTransactionID);
