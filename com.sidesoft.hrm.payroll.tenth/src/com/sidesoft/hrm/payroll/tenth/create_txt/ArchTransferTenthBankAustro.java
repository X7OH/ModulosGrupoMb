...
public class ArchTransferTenthBankAustro extends DalBaseProcess {
  ...
  public void doExecute(ProcessBundle bundle) throws Exception {
    ...
    try {
      ...
      ArchTransferTenthBankAustroData data[] = ArchTransferTenthBankAustroData.select(conn,
      ...
      if (data != null && data.length > 0) {
        ...
        response.setHeader("Content-Disposition",
            "attachment; filename=TransferenciaDecimosBancodelAustro.txt");
        // Build txt file
        ...
        try {
          ...
          out.write("\t");
          out.write("\r\n");   // write new line
          for (ArchTransferTenthBankAustroData archPAPProduBankData : data) {
