...
package ec.com.sidesoft.custom.purchase.process.ad_forms;
...
public class RequisitionToOrder extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strRequisitionId = vars.getGlobalVariable("inpmRequisitionId",
      ...
      printPageDataSheet(response, vars, strProductId, strDateFrom, strDateTo, strRequesterId,
          strVendorId, strIncludeVendor, strOrgId, strRequisitionId);
      ...
      String strRequesterId = vars.getRequestGlobalVariable("inpRequesterId",
          "RequisitionToOrder|Requester_ID");
      String strRequisitionId = vars.getRequestGlobalVariable("inpmRequisitionId",
          "RequisitionToOrder|M_REQUISITION_ID");
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
      ...
      String strVendorId, String strIncludeVendor, String strOrgId, String strRequisitionId)
      throws IOException, ServletException {
    ...
    RequisitionToOrderData[] datalines = RequisitionToOrderData.selectLines(this,
        vars.getLanguage(), strRequisitionId,
    ...
    xmlDocument = xmlEngine
        .readXmlTemplate("ec/com/sidesoft/custom/purchase/process/ad_forms/RequisitionToOrder",
            discard)
        .createXmlDocument();
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "ec.com.sidesoft.custom.purchase.process.ad_forms.RequisitionToOrder");
    ...
    xmlDocument.setParameter("paramMRequisitionId", strRequisitionId);
    try {
    ...
    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR", "M_Requisition_ID",
          "", "Validation Requisition",
          Utility.getContext(this, vars, "#AccessibleOrgTree", "RequisitionToOrder"),
          Utility.getContext(this, vars, "#User_Client", "RequisitionToOrder"), 0);
      Utility.fillSQLParameters(this, vars, null, comboTableData, "RequisitionToOrder",
          strRequisitionId);
      xmlDocument.setData("reportRequisition_ID", "liststructure", comboTableData.select(false));
      comboTableData = null;
    } catch (Exception ex) {
      throw new ServletException(ex);
    }
  ...
  private void printPageCreate(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine
        .readXmlTemplate(
            "ec/com/sidesoft/custom/purchase/process/ad_forms/RequisitionToOrderCreate")
        .createXmlDocument();
    xmlDocument.setParameter("calendar", vars.getLanguage().substring(0, 2));
