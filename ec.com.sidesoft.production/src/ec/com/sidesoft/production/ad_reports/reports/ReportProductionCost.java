...
//        "org/openbravo/erpCommon/ad_reports/ReportProductionCost").createXmlDocument();
    xmlDocument = xmlEngine.readXmlTemplate(
        "ec/com/sidesoft/production/ad_reports/reports/ReportProductionCost").createXmlDocument();    
...
//            "org.openbravo.erpCommon.ad_reports.ReportProductionCost");
        WindowTabs tabs = new WindowTabs(this, vars,
            "ec.com.sidesoft.production.ad_reports.reports.ReportProductionCost");
...
//        .createXmlDocument();
    xmlDocument = xmlEngine.readXmlTemplate(
        "ec/com/sidesoft/production/ad_reports/reports/ReportProductionCostSubreport", discard)
        .createXmlDocument();    
