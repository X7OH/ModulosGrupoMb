...
public class Tax {
  ...
  private Map<String, BigDecimal> argumentsNumeric;

  public Tax() {
    arguments = new HashMap<String, String>();
    argumentsNumeric = new HashMap<String, BigDecimal>();
  }
  ...
  public void setArgument(String name, BigDecimal value) {
    argumentsNumeric.put(name, value);
  }
  ...
  public String getArgumentsJS() {
    ...
    for (Map.Entry<String, BigDecimal> entry : argumentsNumeric.entrySet()) {
      if (entry.getValue() != null) {
