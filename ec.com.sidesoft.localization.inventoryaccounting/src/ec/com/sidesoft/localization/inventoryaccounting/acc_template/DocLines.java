...
public class DocLines {
  static Logger log4jDocLine = Logger.getLogger(DocLines.class);
  ...
  public DocLines(String DocumentType, String TrxHeader_ID, String TrxLine_ID) {
  ...
  public void loadAttributes(FieldProvider data,ConnectionProvider conn) {
	    m_Record_Id2 = data.getField("cDebtpaymentId");
	    m_AD_Org_ID = data.getField("adOrgId");
	    m_C_BPartner_ID = data.getField("cBpartnerId");
	    m_M_Product_ID = data.getField("mProductId");
	    ...
	    //
	    // Product Info
	    p_productInfo = new ProductInfo(m_M_Product_ID, conn);
  ...
  public void copyInfo(DocLines source) {
